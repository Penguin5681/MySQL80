...
SELECT * FROM EMPLOYEE1 WHERE DEPT_NO = 30 AND SAL > 1500;
SELECT * FROM EMPLOYEE1 WHERE ENAME LIKE 'S%' AND LENGTH(ENAME) = 5;
SELECT EMP_NO, ENAME, JOB, COMM + SAL "TOTAL SALARY" FROM EMPLOYEE1;
SELECT * FROM EMPLOYEE1 WHERE MGR IN (7566, 7698, 7782);
SELECT * FROM EMPLOYEE1 WHERE JOB='CLERK' AND DEPT_NO = 20;
SELECT * FROM (SELECT * FROM EMPLOYEE1 ORDER BY SAL DESC) WHERE ROWNUM <= 3;
SELECT * FROM (SELECT * FROM EMPLOYEE1 ORDER BY SAL ASC) WHERE ROWNUM <= 3;
